...
### Configuración de las páginas de error de CloudFront

Por defecto, S3 devuelve un error 404 cuando el archivo no se encuentra, y 403 cuando el archivo es privado. Esto hace que los visitantes vean una fea página de error XML en ambos casos.

Para solucionarlo, añade **respuestas de error personalizadas** en **Settings > Error pages** de tu distribución de CloudFront.

1. Crea una respuesta de error personalizada para errores 404 con los siguientes valores:
    * **HTTP error code:** 404: Not Found
    * **Customize error response:** Yes
    * **Response page path:** `/index.html`
    * **HTTP response code:** 200: OK

2. Crea una respuesta de error personalizada para errores 403 con los siguientes valores:
  ...
  :::tip
  Para obtener la mejor experiencia de usuario, puedes [crear una página 404 personalizada](/es/basics/astro-pages/#página-de-error-404-personalizada) en tu proyecto y establecer la **ruta de la página de respuesta** a `/404.html`.
  :::
